---
title: "An Introduction to Shiny and R Markdown - Application in Research & Drug Development"
author: "STATISTICAL COMPUTING 2018 - Phil Bowsher & James Black"
date: "Reisensburg Castle, Germany on Mon, July 9th, 2018"
output: 
...
## Workshop Goals - Workshop has 4 Parts

### Part 1-4 - You will learn:
- R & RStudio Setup
- Application of R in Pharma
...
# Part 2 R in Pharma James Black
...
- Create a new multi file shiny app in the IDE by going to 'File' and select 'New File' and select 'Shiny Web App...' and create a new multiple file app and title it 'Statshiny'
